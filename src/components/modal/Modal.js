        ...
        <>
         {modal ?
                 ...
                 <div className="modall__content">
                     ...
                     <div className="modall__content-text">Hi. My name is Denys Rybachok. I developed this app as part of my Portfolio for junior front-end developer position. This page is about my favourite football club Arsenal. During last year I studied HTML, CSS, LESS/SASS, JavaScript, React JS, Redux, Git. This app was created with help of React. Hope you will like it. </div>
                     <div>
                         <ul>
