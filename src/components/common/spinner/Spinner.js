const Spinner = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{margin: '0 auto', background: 'none', display: 'block'}} width="70px" height="70px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
