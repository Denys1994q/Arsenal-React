...
const TeamSubs = () => {
    ...
    const getSearchedHeroData = (res, i) => {
        ...
        const newArray = [...searchedPlayers.slice(0, index), newItem, ...searchedPlayers.slice(index + 1)]; // новий масив, у який входить новий елемент
        ...
        return (
            <div key={item.num} className={`team-bottom-subs-${i + 1}`}>
                ...
                <div className='team-bottom-subs-imgsBox'>
                    ...
                    <div style={{ display: showBtn }} onClick={() => changePlayer(i)} className={iconClass}></div>
